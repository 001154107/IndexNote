...
2. **Native App Intents**: Leveraging the Android/iOS operating system's
...
2. (Optional) Add `require-secret-description: some description` to your
    `SKILL.md` metadata. This will be shown in the prompt dialog.
3. Add a second parameter to your JS entry function to receive the secret.
